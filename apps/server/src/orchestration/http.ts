    ...
    return handlers
      .handle(
        ...
        Effect.fn("environment.orchestration.snapshot")(function* (args) {
          ...
          // Keep this compatibility endpoint lightweight. New consumers use
          // the shell and per-thread endpoints instead of hydrating every
          // message and activity payload in the database.
