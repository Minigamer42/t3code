...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    stopTool: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:stop-tool",
      execute: (input: StopThreadToolInput) => stopThreadTool(input),
      scheduler,
      concurrency,
    }),
