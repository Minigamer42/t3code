...
export type StopThreadToolInput = CommandInput<"thread.tool.stop">;
...
export const stopThreadTool: (input: StopThreadToolInput) => CommandEffect = Effect.fn(
  "EnvironmentCommands.stopThreadTool",
)(function* (input) {
  const metadata = yield* timestampedCommandMetadata(input);
  return yield* dispatch({
    ...input,
